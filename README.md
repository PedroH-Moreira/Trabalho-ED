...
## Observações iniciais
  ...
  - Pode ser que ao baixar a base de dados, uma quebra de linha seja adicionada ao final do arquivo, isso pode causar problemas na execução do programa. Caso ocorra problemas na execução do problema, recomendamos remover essa linha.
